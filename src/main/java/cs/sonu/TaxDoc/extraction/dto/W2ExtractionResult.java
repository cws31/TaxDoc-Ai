...
public record W2ExtractionResult(
        ...
        double overallExtractionConfidence) implements TaxDocumentExtractionResult {

    @Override
    public double getOverallExtractionConfidence() {
        return overallExtractionConfidence;
    }
}